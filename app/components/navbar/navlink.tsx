    ...
    <>
      {session?.user ? (
        <div className="flex items-center justify-end md:order-2">
          <div className="hidden overflow-hidden text-sm bg-gray-50 rounded-full md:me-0 md:block focus:ring-4 focus:ring-gray-300">
            <Image
              className="size-8"
      ...
      text-gray-500 rounded-md md:hidden hover:bg-gray-100"
      >
        {isOpen ? (
      ...
      <div className={clsx("w-full md:block md:w-auto", { hidden: !isOpen })}>
        ...
        >
          <li>
            <Link
              href="/"
              className="block py-2 px-3 text-gray-800 hover:bg-gray-100 rounded-2xl md:hover:bg-transparent md:p-0"
            >
              Home
            </Link>
          </li>
