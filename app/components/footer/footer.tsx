    ...
    <footer className="bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 w-full py-10 md:py-16">
        <div className="grid md:grid-cols-3 gap-7">
          ...
          <div>
            <h4 className="mb-8 font-semibold text-white text-xl ">
              Newsletter
            </h4>
            <p className="text-gray-400">
            ...
            <form action="" className="mt-5">
              <div className="mb-5">
                <input
                  ...
                  placeholder="iqbaladrian@gmail.com"
                />
              </div>
              <button
                className="bg-orange-400 p-3 font-bold text-white w-full
               text-center rounded-sm hover:bg-orange-500"
              >
                Subscribe
              </button>
            </form>
      ...
      <div className="max-w-7xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
        &copy; Copyright 2025 | Iqbal Adrian | All rights reserved.
      </div>
    </footer>
  );
};
